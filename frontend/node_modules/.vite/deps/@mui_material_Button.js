...
var LazyRipple = class _LazyRipple {
  ...
  static use() {
    ...
    const [shouldMount, setShouldMount] = React41.useState(false);
    ripple.shouldMount = shouldMount;
    ripple.setShouldMount = setShouldMount;
    React41.useEffect(ripple.mountEffect, [shouldMount]);
    return ripple;
  }
  mount() {
    if (!this.mounted) {
...
var ButtonGroupButtonContext = React52.createContext(void 0);
if (true) {
...
var Button = React53.forwardRef(function Button2(inProps, ref) {
  const contextProps = React53.useContext(ButtonGroupContext_default);
  const buttonGroupButtonContextPositionClassName = React53.useContext(ButtonGroupButtonContext_default);
  ...
  const startIcon = startIconProp && (0, import_jsx_runtime20.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp
  });
  const endIcon = endIconProp && (0, import_jsx_runtime20.jsx)(ButtonEndIcon, {
